...
class Class4WebhooksApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\WebhookUrl $webhookUrl webhookUrl (required)
     *
     ...
     * Sets the URL for receiving webhook
     *
     * @param  \OpenAPI\Client\Model\WebhookUrl $webhookUrl (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function setWebhookRequest($webhookUrl)
    {
        ...
        if (isset($webhookUrl)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($webhookUrl));
            } else {
                $httpBody = $webhookUrl;
            }
