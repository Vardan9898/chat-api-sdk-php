...
class Class1InstanceApi
{
     ...
     * @param  bool $noWakeup Ignore autowakeup (optional, default to false)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InstanceStatus
     */
    public function getStatus($full = false, $noWakeup = false)
    {
        list($response) = $this->getStatusWithHttpInfo($full, $noWakeup);
        return $response;
    }
     ...
     */
    public function getStatusWithHttpInfo($full = false, $noWakeup = false)
    {
        $request = $this->getStatusRequest($full, $noWakeup);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatusAsync($full = false, $noWakeup = false)
    {
        return $this->getStatusAsyncWithHttpInfo($full, $noWakeup)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatusAsyncWithHttpInfo($full = false, $noWakeup = false)
    {
        $returnType = '\OpenAPI\Client\Model\InstanceStatus';
        $request = $this->getStatusRequest($full, $noWakeup);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getStatusRequest($full = false, $noWakeup = false)
    {
        ...
        // query params
        if ($noWakeup !== null) {
            if('form' === 'form' && is_array($noWakeup)) {
                foreach($noWakeup as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['no_wakeup'] = $noWakeup;
            }
        }
